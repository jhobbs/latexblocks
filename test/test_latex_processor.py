...
from latexblocks.latex_processor import parse_latex_file, render_math, LatexDialectError  # noqa: E402
from latexblocks.structured_math import PageDoc, MathBlock, MathBlockType  # noqa: E402
...
def test_preexpansion_macro_parsing():
    from latexblocks.latex_processor import _parse_preexpansion_macros
    sty = ("junk before\n"
...
def test_preexpansion_expansion_rules():
    from latexblocks.latex_processor import _expand_preexpansion
