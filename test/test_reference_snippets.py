...
Run: docker exec -i mathnotes-static-builder python3 - < test/test_reference_snippets.py
"""
...
def test_rendered_link_text_has_no_raw_references():
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        try:
            ...
            block_index = BlockIndex(mapper)
            block_index.build_index()
            processor = PageRenderer(mapper, block_index)
