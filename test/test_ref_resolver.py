...
from latexblocks.structured_math import MathBlock, MathBlockType
from latexblocks.ref_resolver import RefResolver, labels_from_rendered_html
...
def _notation_fake_index():
    from latexblocks.structured_math import MathBlock, MathBlockType
    from latexblocks.block_index import BlockReference
...
def test_notation_collect_and_rendered_html_labels():
    from latexblocks.ref_resolver import labels_from_rendered_html
